...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const projects = [
    ...
    {
      title: 'Moodtape',
      desc:  'App mobile que recomenda playlists baseadas no humor, com microinterações e haptics.',
      image: 'assets/project-2.jpg',
      tech:  ['React Native', 'Python', 'Spotify API'],
      github: '#', demo: '#',
    },
    {
      title: 'Carpe Store',
      desc:  'E-commerce premium com checkout suave, animações cinematográficas e foco em performance.',
